        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加家庭收入','./member-family-income-add.jsp',600,500)"><i class="layui-icon"></i>添加</button>
                </div>
...
<script>
    layui.use(['laydate','form', 'table'], function(){
        ...
        table.render({
            elem: "#table-demo",
            url: './member?method=memberFamilyIncomeList&id=${sessionScope.map.id}',
            id: 'table-search',
            page: false,
            cols:[
                [
                    {field: 'id', title: 'ID', width:100, fixed: 'left'}
                    ,{field: 'f_name', title: '收入类型', width:100}
                    ,{field: 'f_income', title: '收入金额', width:100}
                    ,{field: 'u_name', title: '家庭成员', width: 100}
                    ,{field: 'f_date', title: '收入时间', width: 180}
        ...
        table.on("tool(table-demo)", function(obj){
            ...
            if(obj.event === 'del') {
                ...
                xadmin.open('编辑','member-family-income-edit.jsp?id='+id+'&f_name='+f_name+'&u_name='+u_name+'&f_date='+f_date+'&f_income='+f_income,600,500);
            }
        });
