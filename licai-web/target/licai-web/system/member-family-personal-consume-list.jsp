        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加成员消费','./member-family-personal-consume-add.jsp',600,500)"><i class="layui-icon"></i>添加</button>
                </div>
...
<script>
    layui.use(['laydate','form', 'table'], function(){
        ...
        table.render({
            elem: "#table-demo",
            url: './member?method=memberFamilyPersonalConsumeList&id=${sessionScope.map.id}',
            id: 'table-search',
            page: false,
            cols:[
                [
