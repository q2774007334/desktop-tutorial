        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加会员','./member-add.jsp',600,500)"><i class="layui-icon"></i>添加</button>
                </div>
                ...
                <script type="text/html" id="stopUser">
                    {{# if(d.u_stop == 1){ }}
                    <a class="layui-btn layui-btn-xs" lay-event="stop" data-id="{{d.id}}" data-use="{{d.u_stop}}" onclick="stopUser(this)">已审核</a>
                    {{# }else{  }}
                    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="stop" data-id="{{d.id}}" data-use="{{d.u_stop}}" onclick="stopUser(this)">未审核</a>
                    {{# } }}
                </script>
            </div>
        </div>
        ...
        table.render({
            ...
            cols:[
                [
                    ...
                    ,{field: 'u_stop', title: '是否审核', width: 177, templet: '#stopUser'}
                    ...
                    layui.layer.msg("更新成功", {time:500}, function() {
                        switch (value) {
                            case 1:
                                $(obj).html("已审核");
                                $(obj).data("use", value);
                                $(obj).removeClass("layui-btn layui-btn-danger layui-btn-xs");
                                $(obj).addClass("layui-btn layui-btn-xs");
                                break;
                            case 0:
                                $(obj).html("未审核");
                                $(obj).data("use", value);
                                $(obj).removeClass("layui-btn layui-btn-xs");
                                $(obj).addClass("layui-btn layui-btn-danger layui-btn-xs");
                                break;
                        }
                    });
                }
