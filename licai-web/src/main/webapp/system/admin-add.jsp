    ...
    layui.use(['form','layer'], function() {
        ...
        form.on('submit(add)', function (data) {
            $.ajax({
                url: './user',
                type: 'post',
                data: {'method':'addAdmin', 'username':data.field.username, 'pass':data.field.pass, 'repass':data.field.repass, 'email':data.field.email, 'tel':data.field.tel, 'img':data.field.img, 'desc':data.field.desc},
                dataType: 'json',
