...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                <label for="L_username" class="layui-form-label">
                    <span class="x-red">*</span>时间设置</label>
    ...
    layui.use(['form','layer', 'laydate'], function() {
        ...
        form.on('submit(add)', function (data) {
            ...
            $.ajax({
                url: './member',
                type: 'post',
                data: {'method':'addMemberFamilyConsume', 'username':data.field.username, "f_name": data.field.f_name, 'f_income': data.field.f_income, "f_date": data.field.f_date},
                dataType: 'json',
